...
function submitForm(btn) {
  ...
  // The btn is now passed as a parameter from the function call on line 91  instead of the original click
  // event, but it still works exactly the same.
  let pImage =
    btn.parentElement.parentElement.children[0].children[0].children[0].src;

  let pName =
    btn.parentElement.parentElement.children[0].children[1].children[1]
      .children[1].value;

  let pTitle =
    btn.parentElement.parentElement.children[0].children[1].children[2]
      .children[1].value;

  let pTelNumber =
    btn.parentElement.parentElement.children[0].children[2].children[1]
      .children[1].value;

  let pEmail =
    btn.parentElement.parentElement.children[0].children[2].children[2]
      .children[1].value;

  let pWebsite =
    btn.parentElement.parentElement.children[0].children[2].children[3]
      .children[1].value;

  // Experience Section Declaration
  let expSection = btn.parentElement.parentElement.children[1];
  let companyName =
    expSection.children[1].children[0].children[0].children[1].value;

  let jobTitle =
    expSection.children[1].children[0].children[1].children[1].value;

  let startDate =
    expSection.children[1].children[1].children[0].children[1].value;

  let endDate =
    expSection.children[1].children[1].children[1].children[2].value;

  let jobDescription = expSection.children[1].children[2].children[1].value;

  // Profile section declaration
  let profileSummary =
    btn.parentElement.parentElement.children[2].children[1].children[1].value;

  let certificate =
    btn.parentElement.parentElement.children[2].children[2].children[0]
  ...
  let colStartDate =
    btn.parentElement.parentElement.children[2].children[2].children[1]
      .children[0].children[1].value;
  ...
  let pSkill =
    btn.parentElement.parentElement.children[2].children[3].children[0]
  ...
  collegeDates.innerHTML = ` <div class="collegeStartDate">${colStartDate}</div>
  ...
  skillHobby.innerHTML = `<div class="personSkills">
